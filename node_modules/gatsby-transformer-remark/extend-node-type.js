...
const eachPromise = (input, iterator) => input.reduce((accumulatorPromise, nextValue) => accumulatorPromise.then(() => void iterator(nextValue)), Promise.resolve());
...
module.exports = (_ref2, _ref = {}) => {
  let type = _ref2.type,
      pathPrefix = _ref2.pathPrefix,
      getNode = _ref2.getNode,
      getNodesByType = _ref2.getNodesByType,
      cache = _ref2.cache,
      possibleGetCache = _ref2.getCache,
      reporter = _ref2.reporter,
      rest = (0, _objectWithoutPropertiesLoose2.default)(_ref2, ["type", "pathPrefix", "getNode", "getNodesByType", "cache", "getCache", "reporter"]);
  let _ref$type = _ref.type,
      typeName = _ref$type === void 0 ? `MarkdownRemark` : _ref$type,
      _ref$plugins = _ref.plugins,
      plugins = _ref$plugins === void 0 ? [] : _ref$plugins,
      blocks = _ref.blocks,
      _ref$commonmark = _ref.commonmark,
      commonmark = _ref$commonmark === void 0 ? true : _ref$commonmark,
      _ref$footnotes = _ref.footnotes,
      footnotes = _ref$footnotes === void 0 ? true : _ref$footnotes,
      _ref$gfm = _ref.gfm,
      gfm = _ref$gfm === void 0 ? true : _ref$gfm,
      _ref$pedantic = _ref.pedantic,
      pedantic = _ref$pedantic === void 0 ? true : _ref$pedantic,
      _ref$tableOfContents = _ref.tableOfContents,
      tableOfContents = _ref$tableOfContents === void 0 ? {
    heading: null,
    maxDepth: 6
  } : _ref$tableOfContents,
      grayMatterOptions = (0, _objectWithoutPropertiesLoose2.default)(_ref, ["type", "plugins", "blocks", "commonmark", "footnotes", "gfm", "pedantic", "tableOfContents"]);
  ...
  return new Promise((resolve, reject) => {
    ...
    function _getMarkdownAST() {
      _getMarkdownAST = (0, _asyncToGenerator2.default)(function* (markdownNode) {
        ...
        yield eachPromise(plugins, plugin => {
          const requiredPlugin = require(plugin.resolve);
